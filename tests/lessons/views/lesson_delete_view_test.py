...
class LessonDeleteViewTest(BaseTestCase):
    VALID_TEACHER_DATA = {
        'username': 'test_user',
        'password': 'test_pass',
        'email': 'test@abv.bg',
    ...
    def test_lesson_delete__when_not_accessed_by_the_creator__expect_redirect(self):
        ...
        response = self.client.get(reverse_lazy('lesson-delete', kwargs={'pk': lesson.pk}))
