...
from tests.utils.creation_utils import create_lesson_for_1_user, create_material_for_1_user


class MaterialDeleteViewTest(BaseTestCase):
    VALID_TEACHER_DATA = {
        'username': 'test_user',
        'password': 'test_pass',
        'email': 'test@abv.bg',
    ...
    def test_material_delete__when_not_accessed_by_the_creator__expect_redirect(self):
        ...
        response = self.client.get(reverse_lazy('materials-delete', kwargs={'pk': material.pk}))
