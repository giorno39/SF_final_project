...
class PaperDeleteViewTest(BaseTestCase):
    VALID_TEACHER_DATA = {
        'username': 'test_user',
        'password': 'test_pass',
        'email': 'test@abv.bg',
    ...
    def test_paper_delete__when_not_accessed_by_the_creator__expect_redirect(self):
        ...
        response = self.client.get(reverse_lazy('term-paper-delete', kwargs={'pk': paper.pk}))
